...
let Chaincode = class {
    ...
    async queryUserActivity(stub, args) {
        console.log('============= START : queryUserActivity ===========');
        console.log('##### queryUserActivity arguments: ' + JSON.stringify(args));

        // args is passed as a JSON string
        let json = JSON.parse(args);
        let key = 'activity-' + json['username'];
        ...
        if (!resultAsBytes || resultAsBytes.toString().length <= 0) {
            ...
            value = JSON.parse(resultAsBytes.toString())
        }
        return Buffer.from(JSON.stringify(value));
    }

    async updateUserActivity(stub, args) {
        console.log('============= START : updateUserActivity ===========');
        console.log('##### updateUserActivity arguments: ' + JSON.stringify(args));
        ...
        console.log('============= END : updateUserActivity ===========');
    }
